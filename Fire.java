...
public class Fire {
    ...
    public void specialAttack1() {
        ...
        System.out.println(name + " used Fire Tornado Attack and dealt " + damage + " damage!");
    }

    public void specialAttack2() {
        int damage = random.nextInt(8) + 18;
        System.out.println(name + " used Ember and dealt " + damage + " damage!");
    }

    public void heal() {
        int healingAmount = random.nextInt(5) + 5; 
