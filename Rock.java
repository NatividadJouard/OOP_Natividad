...
public class Rock {
    ...
    public void specialAttack1() {
        ...
        System.out.println(name + " used Rock Throw and dealt " + damage + " damage!");
    }

    public void specialAttack2() {
        int damage = random.nextInt(8) + 18; 
        System.out.println(name + " used Rock Slide and dealt " + damage + " damage!");
    }

   
    public void heal() {
        int healingAmount = random.nextInt(10) + 5; 
